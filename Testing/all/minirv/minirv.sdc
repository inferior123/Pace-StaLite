...
set_input_delay  0 -clock clk [get_ports {reset io_master_awready io_master_wready io_master_bvalid io_master_arready io_master_rvalid io_master_rlast io_interrupt io_slave_awvalid io_slave_wvalid io_slave_wlast io_slave_bready io_slave_arvalid io_slave_rready}]
